    ...
    try {
      ...
      const response = await fetch("/api/gerar-pix", {
        ...
        body: JSON.stringify({
          ...
          amount: amount,
                  utm_source: (utmData as any).utm_source || null,
        utm_medium: (utmData as any).utm_medium || null,
        utm_campaign: (utmData as any).utm_campaign || null,
        utm_term: (utmData as any).utm_term || null,
        utm_content: (utmData as any).utm_content || null,
        click_id: (utmData as any).click_id || null,
        CampaignID: (utmData as any).CampaignID || null,
        CreativeID: (utmData as any).CreativeID || null,
        }),
      })
    ...
    const checkPayment = async () => {
      ...
      try {
        ...
        if (isPaid) {
          ...
          setTimeout(() => {
            window.location.href = "/bilhete-premiado"
          }, 2000)
        }
                  ...
                  >
                    ...
                    <div className="space-y-5">
                      ...
                      <Button
                        ...
                        className="w-full bg-gradient-to-r from-yellow-600 to-amber-500 hover:from-yellow-700 hover:to-amber-600 text-black py-3 rounded-lg font-medium transition-all duration-200 flex items-center justify-center group"
                      >
                        Continuar
